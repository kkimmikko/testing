...
LIVE_COMBAT_LOG_PATH = 'C:/Games/Steam/steamapps/common/dota 2 beta/game/dota/'
#LIVE_COMBAT_LOG_PATH = 'D:/Project/Dota 2 Automated Camera/python/dotacamera'

PARSED_COMBAT_LOG_PATH = "./parsed_combat_log1.csv"
...
class ChangeHandler(FileSystemEventHandler):
    ...
    print('test')
    if os.path.exists(LIVE_COMBAT_LOG_PATH + 'combatlog.txt'):
        file = open(LIVE_COMBAT_LOG_PATH + 'combatlog.txt', 'r')
        prev_data = file.read()
    ...
    def on_modified(self, event):
        if 'combatlog' in event.src_path:
            print('update found')
